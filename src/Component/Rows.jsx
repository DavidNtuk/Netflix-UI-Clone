  ...
  return (
    <>
        ...
        <div className='relative items-center flex group'>
            <MdChevronLeft 
            onClick={slideLeft}
            size={40} className='bg-white rounded-full absolute z-10 opacity-40 hover:opacity-100 cursor-pointer hidden group-hover:block'/>
                <div id={'slider' + rowId} className='w-full h-full whitespace-nowrap overflow-x-scroll scrollbar-hide scroll-smooth'>
                    {
                        movies?.map((item, id)=>{
                            return(
